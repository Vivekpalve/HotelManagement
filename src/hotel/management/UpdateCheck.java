...
public class UpdateCheck extends JFrame {
	 ...
	 */
		...
		contentPane.add(lblUpdateCheckStatus);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("icons/Copy of nine.jpg"));
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) { 
				...
				String s2 = txt_ID.getText(); //room    
                                ...
                                c.s.executeUpdate("update customer set room = '"+s2+"', name = '"+s3+"', checkintime = '"+s4+"', deposite = '"+s5+"' where number = '"+s1+"'");
