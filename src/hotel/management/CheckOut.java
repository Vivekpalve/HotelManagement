...
public class CheckOut extends JFrame{
	...
	public CheckOut() throws SQLException {
		...
		setBounds(200, 200, 800, 294);
		contentPane = new JPanel();
		contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
		setContentPane(contentPane);
		contentPane.setLayout(null);
                
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("icons/Copy of sixth.jpg"));
		...
		contentPane.add(c1);
                ...
                ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/Copy of tick.png"));
